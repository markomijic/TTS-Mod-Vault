...
static void my_application_activate(GApplication* application) {
  ...
  const string iconFilename = "assets/icon/tts_mod_vault_icon.png";
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "tts_mod_vault");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "tts_mod_vault");
  }
